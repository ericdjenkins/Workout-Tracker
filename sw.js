const CACHE='eric-jenkins-workout-v5';
const ASSETS=['./','index.html','styles.css','app.js','manifest.webmanifest','icons/icon.svg','icons/icon-192.png','icons/icon-512.png','images/eric-profile-v3.jpg'];
