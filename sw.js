const CACHE='eric-jenkins-workout-v4';
const ASSETS=['./','index.html','styles.css','app.js','manifest.webmanifest','icons/icon.svg','icons/icon-192.png','icons/icon-512.png','images/eric-lean-bucket-hat-v2.png'];
